## 3.2. Nhánh Biên - Thuật toán Dò biên Canny (Canny Edge Detection)

Là một đối trọng với bộ lọc Hình thái học, thuật toán Canny được triển khai từ đầu (from scratch) nhằm bóc tách các khuyết tật dạng tuyến tính (vết xước, sợi đứt) dựa trên sự biến thiên cường độ (Gradient). Quá trình thi hành gồm các giai đoạn cốt lõi:
