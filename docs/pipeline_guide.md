...
Tài liệu này cung cấp các lệnh tuần tự để chạy toàn bộ hệ thống từ dữ liệu thô (Raw) đến khi trích xuất ra file CSV đặc trưng, chuẩn bị cho khâu Machine Learning.
...
## 4. Kiểm tra Đầu ra (Output Verification)
Sau khi hoàn tất, hệ thống sẽ sinh ra:
...
- Các ảnh Overlay được khoanh vùng (Bounding Box) đỏ nằm trong các thư mục con tương ứng. Sẵn sàng cho Module Machine Learning!