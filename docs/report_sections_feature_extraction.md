...
- **Directional Gradient Pipeline (Bị áp đảo bởi kết cấu vải):** Mặc dù đã dùng các phép đóng có hướng (Directional Closing) để hàn gắn đường xước, thuật toán Directional Gradient vẫn bắt nhầm kết cấu đan chéo của sợi vải (Fabric Weave Texture) làm viền biên. Hậu quả là ở các ảnh vải lành lặn, độ dài đứt gãy vẫn cao, sinh ra lượng Báo động giả (False Positives) lớn. 

**Kết luận thực nghiệm:** Việc thiết lập 2 luồng A/B Testing đã mang lại minh chứng khoa học đắt giá. Trên nền vật liệu có kết cấu đan xen như vải dệt, thuật toán Hình thái học (Morphological) thể hiện sự ưu việt tuyệt đối so với các toán tử dò biên Gradient cục bộ (Directional Gradient).